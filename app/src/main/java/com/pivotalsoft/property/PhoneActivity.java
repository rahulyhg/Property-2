...
import com.pivotalsoft.property.utilities.Session;
...
public class PhoneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(session.loggedin()){
            startActivity(new Intent(PhoneActivity.this,BottamNavgationActivity.class));
            finish();
        }
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                           ...
                           //user phone number has been verified, what next?
                            ...
                            Intent i = new Intent(PhoneActivity.this,BottamNavgationActivity.class);
