...
public class EditCertificatesActivity extends AppCompatActivity implements View.OnClickListener {
    final int RADIOBUTTON_ALERTDIALOG = 1;
    final boolean checked_state[] = {false, false, false};
    final CharSequence[] day_radio =  {"CREDAI Certificate","Local Authority Certification","Other Certification"};
    //Image request code
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Edit Certifications");
    ...
    public Dialog onCreateDialog(int id) {
        switch (id) {
            ...
            case RADIOBUTTON_ALERTDIALOG:
                ...
                AlertDialog.Builder builder2 = new AlertDialog.Builder(EditCertificatesActivity.this)
        ...
        if (requestCode == PICK_IMAGE_REQUEST1 && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                if (size < 200) {
                    ...
                    Toast.makeText(EditCertificatesActivity.this, "please select File size must be 200 kb  or below.", Toast.LENGTH_LONG).show();
                }
        ...
        StringRequest dr = new StringRequest(Request.Method.DELETE, DELETE_URL,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Intent delete = new Intent(EditCertificatesActivity.this, ProfileActivity.class);
                        delete.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                        startActivity(delete);
                        Toast.makeText(EditCertificatesActivity.this, "Document Delete Successfully", Toast.LENGTH_LONG).show();
                    }
                },
