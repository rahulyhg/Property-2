...
public class AddCertificatesActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_certifcate);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setDisplayShowTitleEnabled(true);
        getSupportActionBar().setTitle("Add Certificates");
    ...
    public Dialog onCreateDialog(int id) {
        switch (id) {
            ...
            case RADIOBUTTON_ALERTDIALOG:
                ...
                AlertDialog.Builder builder2 = new AlertDialog.Builder(AddCertificatesActivity.this)
        ...
        if (requestCode == PICK_IMAGE_REQUEST1 && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                ...
                if (size<200){
                    ...
                    Toast.makeText(AddCertificatesActivity.this, "please select File size must be 200 kb  or below.", Toast.LENGTH_LONG).show();
                }
